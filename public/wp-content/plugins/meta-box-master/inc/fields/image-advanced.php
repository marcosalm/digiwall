...
if ( ! class_exists( 'RWMB_Image_Advanced_Field' ) )
{
	class RWMB_Image_Advanced_Field extends RWMB_Image_Field
	{
		...
		static function html( $meta, $field )
		{
			...
			$html .= "<div class='telas telas-media telas-media-dois-esquerda'><a href='#' class='{$classes}' data-attach_media_nonce={$attach_nonce}>{$i18n_title}</a>				</div> ";
			break;
			
			
			case 'half_right':
			
			$html .= "<div class='telas telas-media telas-media-dois-direita'><a href='#' class='{$classes}' data-attach_media_nonce={$attach_nonce}>{$i18n_title}</a></div>";
			break;
			
			
			case 'split-right_upper':
			
			$html .= "<div class='telas telas-media telas-media-dois-direita'>
									<div class='telas telas-media telas-media-vertical-cima'>
									<a href='#' class='{$classes}' data-attach_media_nonce={$attach_nonce}>{$i18n_title}</a>
				</div>";
			break;
			
			
			case 'split-right_down':
			
			$html .= " <div class='telas telas-media telas-media-vertical-baixo'>
					 <a href='#' class='{$classes}' data-attach_media_nonce={$attach_nonce}>{$i18n_title}</a>
			...
			$html .= "  	<div class='telas telas-media telas-media-tres'>
										<a href='#' class='{$classes}' data-attach_media_nonce={$attach_nonce}>{$i18n_title}</a>
			...
			$html .= " <div class='telas telas-media telas-media-tres'>	<a href='#' class='{$classes}' data-attach_media_nonce={$attach_nonce}>{$i18n_title}</a> </div>";
			break;
