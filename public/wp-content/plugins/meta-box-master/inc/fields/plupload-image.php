...
if ( ! class_exists( 'RWMB_Plupload_Image_Field' ) )
{
	class RWMB_Plupload_Image_Field extends RWMB_Image_Field
	{
		...
		static function html( $meta, $field )
		{
			...
			$i18n_drop   = apply_filters( 'rwmb_plupload_image_drop_string', _x( 'Arraste sua mídia até aqui', 'image upload', 'rwmb' ), $field );
			$i18n_or     = apply_filters( 'rwmb_plupload_image_or_string', _x( 'or', 'image upload', 'rwmb' ), $field );
			$i18n_select = apply_filters( 'rwmb_plupload_image_select_string', _x( 'Select File', 'image upload', 'rwmb' ), $field );
			...
			// Show form upload - rwmb-thickbox-upload
			switch ($field['id']) {
			
			case 'full_image':
			
			$html .= sprintf(
				'%s<div id="%s-dragdrop" class="%s" data-upload_nonce="%s" data-js_options="%s">
				...
				self::get_uploaded_images( $meta, $field ),
				$field['id'],
				implode( ' ', $classes ),
			...
			$html .= sprintf('<div class="telas telas-media telas-media-dois-direita">
									%s
									 <div id="%s-dragdrop" class="%s" data-upload_nonce="%s" data-js_options="%s">
					<div class = "drag-drop-inside">
						<p class="drag-drop-info">%s</p>
			...
			$html .= sprintf('   <div class="telas telas-media telas-media-tres">
			%s
									 <div id="%s-dragdrop" class="%s" data-upload_nonce="%s" data-js_options="%s">
										<div class = "drag-drop-inside">
											<p class="drag-drop-info">%s</p>
